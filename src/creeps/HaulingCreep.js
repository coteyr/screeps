...
HaulingCreep.prototype.transfer = function(target) {
  if(this.orignalTransfer(target, RESOURCE_ENERGY) === ERR_NOT_IN_RANGE) this.goTo(target)/*, { reusePath: 10, ignoreCreeps: false, ignoreRoads: true, costCallback: function(roomName, costMatrix) {
